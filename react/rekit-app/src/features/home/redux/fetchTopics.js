  ...
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        (res) => {
          dispatch({
            type: HOME_FETCH_TOPICS_SUCCESS,
            data: res,
          });
          resolve(res);
        },
        ...
        (err) => {
          dispatch({
            type: HOME_FETCH_TOPICS_FAILURE,
            data: { error: err },
          });
          reject(err);
        },
...
export function reducer(state, action) {
  switch (action.type) {
    ...
    case HOME_FETCH_TOPICS_SUCCESS:
    ...
    case HOME_FETCH_TOPICS_FAILURE:
    ...
    case HOME_FETCH_TOPICS_DISMISS_ERROR:
